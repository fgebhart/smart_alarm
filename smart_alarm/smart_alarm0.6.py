...
# from display import display_scroll, set_display_brightness, display_show_time
# from sounds import adjust_volume, say, play_mp3_file, play_online_stream, play_wakeup_music
from sounds import *
from xml_belongings import *
# from xml_belongings import find_most_recent_news_url_in_xml_file,
        ...
        if today_nr in alarm_days:      # check if current day is programmed to alarm
            ...
            if time_to_alarm == 0:
                ...
                if content == 'news':
                    ...
                    b = threading.Thread(target=play_online_stream, args=())
                    b.start()
